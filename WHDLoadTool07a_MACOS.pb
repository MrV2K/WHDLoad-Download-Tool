...
;
; [ PB V5.7x/V6.x / 64Bit / Linux Ubuntu 20+]
;
; A downloader for Retroplay's WHDLoad archive and more!
;
;- ############### Credits
;
...
;============================================
;
; FTP Connection is a bit unreliable.
;
;============================================
;
...
Procedure Edit_List()
  ...
  ListIconGadget(#EDIT_LIST,0,0,360,465,"",450,#PB_ListIcon_FullRowSelect | #PB_ListIcon_CheckBoxes)
...
Procedure.b Download_Preview()
  ...
  If OpenWindow(#DOWNLOAD_WINDOW,0,0,300,450,"FTP Download ("+Str(ListSize(Down_List()))+" Files)",#PB_Window_Tool|#PB_Window_WindowCentered,WindowID(#MAIN_WINDOW))
    ...
    ListIconGadget(#DOWNLOAD_LIST,0,0,300,400,"Files To Delete",450,#PB_ListIcon_FullRowSelect)
...
Procedure About_Window()
  ...
  OpenWindow(#ABOUT_WINDOW,0,0,400,300,"About", #PB_Window_SystemMenu|#PB_Window_WindowCentered,WindowID(#MAIN_WINDOW))
  ...
  EditorGadget(#ABOUT_STRING,0,0,400,270, #PB_Editor_ReadOnly | #PB_Editor_WordWrap)
  SetGadgetText(#ABOUT_STRING, output$)
...
Procedure Main_Window()
  ...
  OpenWindow(#MAIN_WINDOW,5,5,910,750,"",#PB_Window_ScreenCentered|#PB_Window_SystemMenu|#PB_Window_MinimizeGadget)
  ...
  ListIconGadget(#MAIN_LIST,5,5,405,715,"File List",405,#PB_ListIcon_FullRowSelect)
  
  SetGadgetFont(#MAIN_LIST,FontID(#MAIN_FONT))
  
  FrameGadget(#PB_Any,415,0,360,185,"FTP Info")
  
  TextGadget(#PB_Any,425,25,80,25,"User Name")
  StringGadget(#FTP_USER_STRING,535,20,230,20,ftp_user)
  
  TextGadget(#PB_Any,425,65,80,25,"Password")
  StringGadget(#FTP_PASS_STRING,535,60,230,20,ftp_pass)
  
  TextGadget(#PB_Any,425,105,80,25,"Server")
  StringGadget(#FTP_SERVER_STRING,535,100,120,20,ftp_server,#PB_String_ReadOnly)
  
  TextGadget(#PB_Any,675,105,25,25,"Port")
  StringGadget(#FTP_PORT_STRING,725,100,40,20,Str(ftp_port),#PB_String_ReadOnly)
  
  TextGadget(#PB_Any,425,145,80,25,"FTP Folder")
  StringGadget(#FTP_FOLDER_STRING,535,140,230,20,ftp_Folder,#PB_String_ReadOnly)
  
  FrameGadget(#PB_Any,415,190,360,275,"Folder Settings")
  
  TextGadget(#PB_Any,425,221,40,25,"Parent")  
  StringGadget(#WHD_MAIN_STRING,480,215,150,25,WHD_Folder,#PB_String_ReadOnly)
  ButtonGadget(#WHD_OPEN_PATH_BUTTON,637,215,35,25,"Open")
  ButtonGadget(#WHD_SET_PATH_BUTTON,713,215,35,25,"Set")
  
  CheckBoxGadget(#GAME_OPTION,425,260,20,20,"")
  TextGadget(#PB_Any,455,261,40,25,"Games")
  StringGadget(#WHD_GAME_STRING,515,255,180,25,WHD_Game_Folder)
  ButtonGadget(#WHD_OPEN_GAME_BUTTON,700,255,40,25,"Open") 
  
  CheckBoxGadget(#DEMO_OPTION,425,305,20,20,"")
  TextGadget(#PB_Any,455,306,40,25,"Demos")
  StringGadget(#WHD_DEMO_STRING,515,300,180,25,WHD_Demo_Folder)
  ButtonGadget(#WHD_OPEN_DEMO_BUTTON,700,300,40,25,"Open")
  
  CheckBoxGadget(#BETA_OPTION,425,350,20,20,"")
  TextGadget(#PB_Any,455,351,40,25,"Beta")
  StringGadget(#WHD_BETA_STRING,515,345,180,25,WHD_Beta_Folder)
  ButtonGadget(#WHD_OPEN_BETA_BUTTON,700,345,40,25,"Open")
  
  CheckBoxGadget(#MAGS_OPTION,425,395,20,20,"")
  TextGadget(#PB_Any,455,396,40,25,"Mags")
  StringGadget(#WHD_MAGS_STRING,515,390,180,25,WHD_Mags_Folder)
  ButtonGadget(#WHD_OPEN_MAGS_BUTTON,700,390,40,25,"Open")
  
  CheckBoxGadget(#WHD_SUBFOLDER_CHECK,445,435,140,21,"Use Subfolders")
  SetGadgetState(#WHD_SUBFOLDER_CHECK,Use_Subfolder)
  CheckBoxGadget(#WHD_0TOZ_CHECK,595,435,140,21,"Add 0-Z Subfolders")
  ...
  FrameGadget(#PB_Any,415,470,360,250,"Filter")
  
  FrameGadget(#PB_Any,420,490,175,100,"System")
  
  CheckBoxGadget(#AMIGA_OPTION,425,510,60,25,"Amiga")
  CheckBoxGadget(#ARCADIA_OPTION,505,510,60,25,"Arcadia")
  CheckBoxGadget(#CD32_OPTION,425,535,60,25,"CD32")
  CheckBoxGadget(#CDTV_OPTION,505,535,60,25,"CDTV")
  CheckBoxGadget(#CDROM_OPTION,425,560,60,23,"CDROM")
  
  FrameGadget(#PB_Any,420,595,175,120,"Extras")
  
  CheckBoxGadget(#AGA_OPTION,425,615,60,20,"AGA")
  CheckBoxGadget(#ECS_OPTION,505,615,65,20,"ECS/OCS")
  CheckBoxGadget(#NTSC_OPTION,425,640,60,20,"NTSC")
  CheckBoxGadget(#PAL_OPTION,505,640,60,20,"PAL")  
  CheckBoxGadget(#CHIP_OPTION,425,665,60,18,"Chip")
  CheckBoxGadget(#FAST_OPTION,505,665,60,18,"Fast")
  CheckBoxGadget(#FILES_OPTION,425,690,60,18,"Files")
  CheckBoxGadget(#IMAGE_OPTION,505,690,60,18,"Image")
  
  FrameGadget(#PB_Any,600,490,170,225,"Language")
  
  CheckBoxGadget(#CZECH_OPTION,605,510,60,25,"Czech")
  CheckBoxGadget(#GREEK_OPTION,685,510,60,25,"Greek")
  CheckBoxGadget(#DANISH_OPTION,605,535,60,25,"Danish") 
  CheckBoxGadget(#ITALIAN_OPTION,685,535,60,25,"Italian")
  CheckBoxGadget(#DUTCH_OPTION,605,560,60,25,"Dutch")
  CheckBoxGadget(#MULTI_OPTION,685,560,60,25,"Multi")
  CheckBoxGadget(#ENGLISH_OPTION,605,585,60,25,"English")
  CheckBoxGadget(#POLISH_OPTION,685,585,60,25,"Polish")
  CheckBoxGadget(#FINNISH_OPTION,605,610,60,25,"Finnish") 
  CheckBoxGadget(#SPANISH_OPTION,685,610,60,25,"Spanish")
  CheckBoxGadget(#FRENCH_OPTION,605,635,60,25,"French")
  CheckBoxGadget(#SWEDISH_OPTION,685,635,60,25,"Swedish")
  CheckBoxGadget(#GERMAN_OPTION,605,660,60,22,"German")
  ButtonGadget(#CLEAR_LANG_BUTTON,690,670,75,22,"Clear")  
  
  ; #### Button List
  
  FrameGadget(#PB_Any,780,0,125,105,"FTP Actions")
  
  ButtonGadget(#SCAN_BUTTON,785,20,115,30,"Load Data")
  ButtonGadget(#DOWNLOAD_BUTTON,785,60,115,30,"Download")
  
  FrameGadget(#PB_Any,780,110,125,225,"Lists")
  
  ButtonGadget(#LIST_EDIT_BUTTON,785,130,115,30,"Edit List")  
  ButtonGadget(#LIST_LOAD_BUTTON,785,170,115,30,"Load List")
  ButtonGadget(#LIST_SAVE_BUTTON,785,210,115,30,"Save List")
  ButtonGadget(#LIST_APPEND_BUTTON,785,250,115,30,"Append List")
  ButtonGadget(#CLEAR_EDITS_BUTTON,785,290,115,30,"Clear Edits")
  
  FrameGadget(#PB_Any,780,340,125,105,"Data")
  
  ButtonGadget(#CLEANUP_BUTTON,785,360,115,30,"Clean Files") 
  ButtonGadget(#CLEAR_LIST_BUTTON,785,400,115,30,"Clear Data")   
  
  FrameGadget(#PB_Any,780,450,125,185,"Misc")
  
  ButtonGadget(#SAVE_PREFS_BUTTON,785,470,115,30,"Save Prefs")
  ButtonGadget(#LOAD_PREFS_BUTTON,785,510,115,30,"Load Prefs")   
  ButtonGadget(#HELP_BUTTON,785,550,115,30,"Help")
  ButtonGadget(#ABOUT_BUTTON,785,590,115,30,"About")
  ButtonGadget(#CLEAR_BUTTON,785,645,115,27,"Clear Filter")
  ButtonGadget(#RESET_BUTTON,785,685,115,27,"Reset Filter") 
...
End
; IDE Options = PureBasic 6.00 Beta 2 (MacOS X - x64)
...
; EnableThread
; EnableXP
; Executable = WHDLoadTool_x64
; Compiler = PureBasic 6.00 Beta 2 (MacOS X - x64)
; Debugger = Standalone