      ...
      If OpenFTPEx(#FTP,#PBEx_FTP_Protocol_FTP,FTP_Server,FTP_Port,FTP_User,FTP_Pass,#PB_Ascii,@ErrorOutput$)
        ...
        If SetFTPDirectoryEx(#FTP,FTP_Folder,@ErrorOutput$) 
          ...
          ForEach Down_List() 
            ...
            Protected down_file.s
            
;            Define *Ascii
;             *Ascii=AllocateMemory(80)
;             *Ascii=Ascii(Down_List()\Down_Name)
;             down_file=PeekS(*Ascii,80,#PB_Ascii)
;             Debug down_file
            down_file=Down_List()\Down_Name
            If ReceiveFTPFileEx(#FTP,down_file, down_path,#False,@ErrorOutput$)  
              ...
              Else
                ...
                PrintNCol("No data received for file " + Down_List()\Down_Name+". Deleting...",4,0)
