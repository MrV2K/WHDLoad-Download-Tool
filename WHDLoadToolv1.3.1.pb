...
Procedure Filter_List()
  ...
  ForEach Game_List()
    ...
    If Filter(0)\F_Demos=#False And Game_List()\File_Type="Demo" And Game_List()\File_BETA<>#True : Game_List()\File_Filtered=#True : EndIf 
...
; Compiler = PureBasic 6.10 beta 2 (Windows - x64)
; Debugger = Standalone
; Warnings = Display
; IncludeVersionInfo
