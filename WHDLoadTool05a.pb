...
Procedure Download_FTP()
  ...
  Protected ftp_script.s, ftp_string.s, ftp_file.l
          ...
          ForEach Down_List() 
            ...
            If ReceiveFTPFileEx(#FTP,Down_List()\Down_Name,down_path,#False,@ErrorOutput$)  
              If FileSize(down_path)>0
                ...
                PrintN("Downloaded - " + Down_List()\Down_Name+" ("+Str(FileSize(down_path))+" bytes)")       
              Else
                ftp_log+"No data received for file "+Down_List()\Down_Name+". Retrying with DOS FTP..."+#CRLF$
                PrintNCol("No data received for file " + Down_List()\Down_Name+". Retrying with DOS FTP...",4,0)
                DeleteFile(down_path)
                GetFTPDirectoryEx(#FTP,@path$,@ErrorOutput$)
                CloseFTPEx(#FTP,@ErrorOutput$)
                ftp_string=Trim(path$)+"/"+Down_List()\Down_Name
                ...
                If CreateFile(ftp_file,"ftp.txt")
                  ...
                  CloseFile(ftp_file)
                  RunProgram("ftp.exe","-v -s:ftp.txt",GetPathPart(down_path),#PB_Program_Wait)
                EndIf
                DeleteFile("ftp.txt")
                If FileSize(down_path)>0 
                ftp_log+"Downloaded via DOS FTP - "+Down_List()\Down_Name+" ("+Str(FileSize(down_path))+" bytes)"+#CRLF$
                PrintN("Downloaded via DOS FTP - " + Down_List()\Down_Name+" ("+Str(FileSize(down_path))+" bytes)")
                EndIf
                OpenFTPEx(#FTP,#PBEx_FTP_Protocol_FTP,FTP_Server,FTP_Port,FTP_User,FTP_Pass,#PB_Ascii,@ErrorOutput$)
              EndIf
            Else
...
Procedure Main_Window()
  ...
  OpenWindow(#MAIN_WINDOW,5,5,875,577,"",#PB_Window_ScreenCentered|#PB_Window_SystemMenu|#PB_Window_MinimizeGadget)
  ...
  FrameGadget(#PB_Any,455,150,320,160,"Folder Settings")
  ...
  CheckBoxGadget(#MAGS_OPTION,465,258,20,20,"")
  TextGadget(#PB_Any,485,260,40,25,"Mags")
  StringGadget(#WHD_MAGS_STRING,530,257,192,25,WHD_Mags_Folder)
  ButtonGadget(#WHD_OPEN_MAGS_BUTTON,727,257,40,25,"Open")
  CheckBoxGadget(#WHD_SUBFOLDER_CHECK,480,285,140,21,"Use Subfolders")
  SetGadgetState(#WHD_SUBFOLDER_CHECK,Use_Subfolder)
  CheckBoxGadget(#WHD_0TOZ_CHECK,620,285,140,21,"Add 0-Z Subfolders")
  ...
  FrameGadget(#PB_Any,455,310,320,240,"Filter")
   
  FrameGadget(#PB_Any,460,325,150,100,"System")
  
  CheckBoxGadget(#AMIGA_OPTION,465,345,60,25,"Amiga")
  CheckBoxGadget(#ARCADIA_OPTION,530,345,60,25,"Arcadia")
  CheckBoxGadget(#CD32_OPTION,465,370,60,25,"CD32")
  CheckBoxGadget(#CDTV_OPTION,530,370,60,25,"CDTV")
  CheckBoxGadget(#CDROM_OPTION,465,395,60,23,"CDROM")
  CheckBoxGadget(#BETA_OPTION,530,395,60,23,"Beta")
  
  FrameGadget(#PB_Any,460,425,150,120,"Extras")
  
  CheckBoxGadget(#AGA_OPTION,465,445,60,20,"AGA")
  CheckBoxGadget(#ECS_OPTION,530,445,65,20,"ECS/OCS")
  CheckBoxGadget(#NTSC_OPTION,465,470,60,20,"NTSC")
  CheckBoxGadget(#PAL_OPTION,530,470,60,20,"PAL")  
  CheckBoxGadget(#CHIP_OPTION,465,495,60,18,"Chip")
  CheckBoxGadget(#FAST_OPTION,530,495,60,18,"Fast")
  CheckBoxGadget(#FILES_OPTION,465,520,60,18,"Files")
  CheckBoxGadget(#IMAGE_OPTION,530,520,60,18,"Image")
  
  FrameGadget(#PB_Any,615,325,155,190,"Language")
  
  CheckBoxGadget(#CZECH_OPTION,625,340,60,25,"Czech")
  CheckBoxGadget(#GREEK_OPTION,700,340,60,25,"Greek")
  CheckBoxGadget(#DANISH_OPTION,625,365,60,25,"Danish") 
  CheckBoxGadget(#ITALIAN_OPTION,700,365,60,25,"Italian")
  CheckBoxGadget(#DUTCH_OPTION,625,390,60,25,"Dutch")
  CheckBoxGadget(#MULTI_OPTION,700,390,60,25,"Multi")
  CheckBoxGadget(#ENGLISH_OPTION,625,415,60,25,"English")
  CheckBoxGadget(#POLISH_OPTION,700,415,60,25,"Polish")
  CheckBoxGadget(#FINNISH_OPTION,625,440,60,25,"Finnish") 
  CheckBoxGadget(#SPANISH_OPTION,700,440,60,25,"Spanish")
  CheckBoxGadget(#FRENCH_OPTION,625,465,60,25,"French")
  CheckBoxGadget(#SWEDISH_OPTION,700,465,60,25,"Swedish")
  CheckBoxGadget(#GERMAN_OPTION,625,490,60,22,"German")
  ButtonGadget(#CLEAR_LANG_BUTTON,700,489,65,22,"Clear")
